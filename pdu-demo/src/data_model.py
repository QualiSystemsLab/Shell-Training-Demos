...
class PduDemo(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Pdu Demo'
        self._name = name
    ...
    def create_from_context(cls, context):
        ...
        :rtype PduDemo
        """
        result = PduDemo(name=context.resource.name)
    ...
    def user(self):
        ...
        :rtype: str
        """
        return self.attributes['Pdu Demo.User'] if 'Pdu Demo.User' in self.attributes else None
    ...
    def user(self, value):
        ...
        :type value: str
        """
        self.attributes['Pdu Demo.User'] = value
    ...
    def password(self):
        ...
        :rtype: string
        """
        return self.attributes['Pdu Demo.Password'] if 'Pdu Demo.Password' in self.attributes else None
    ...
    def password(self, value):
        ...
        :type value: string
        """
        self.attributes['Pdu Demo.Password'] = value
    ...
    def enable_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Pdu Demo.Enable Password'] if 'Pdu Demo.Enable Password' in self.attributes else None
    ...
    def enable_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Pdu Demo.Enable Password'] = value
    ...
    def power_management(self):
        ...
        :rtype: bool
        """
        return self.attributes['Pdu Demo.Power Management'] if 'Pdu Demo.Power Management' in self.attributes else None
    ...
    def power_management(self, value=True):
        ...
        :type value: bool
        """
        self.attributes['Pdu Demo.Power Management'] = value
    ...
    def contact_name(self):
        ...
        :rtype: str
        """
        return self.attributes['Pdu Demo.Contact Name'] if 'Pdu Demo.Contact Name' in self.attributes else None
    ...
    def contact_name(self, value):
        ...
        :type value: str
        """
        self.attributes['Pdu Demo.Contact Name'] = value
    ...
    def sessions_concurrency_limit(self):
        ...
        :rtype: float
        """
        return self.attributes['Pdu Demo.Sessions Concurrency Limit'] if 'Pdu Demo.Sessions Concurrency Limit' in self.attributes else None
    ...
    def sessions_concurrency_limit(self, value='1'):
        ...
        :type value: float
        """
        self.attributes['Pdu Demo.Sessions Concurrency Limit'] = value
    ...
    def snmp_read_community(self):
        ...
        :rtype: string
        """
        return self.attributes['Pdu Demo.SNMP Read Community'] if 'Pdu Demo.SNMP Read Community' in self.attributes else None
    ...
    def snmp_read_community(self, value):
        ...
        :type value: string
        """
        self.attributes['Pdu Demo.SNMP Read Community'] = value
    ...
    def snmp_write_community(self):
        ...
        :rtype: string
        """
        return self.attributes['Pdu Demo.SNMP Write Community'] if 'Pdu Demo.SNMP Write Community' in self.attributes else None
    ...
    def snmp_write_community(self, value):
        ...
        :type value: string
        """
        self.attributes['Pdu Demo.SNMP Write Community'] = value
    ...
    def snmp_v3_user(self):
        ...
        :rtype: str
        """
        return self.attributes['Pdu Demo.SNMP V3 User'] if 'Pdu Demo.SNMP V3 User' in self.attributes else None
    ...
    def snmp_v3_user(self, value):
        ...
        :type value: str
        """
        self.attributes['Pdu Demo.SNMP V3 User'] = value
    ...
    def snmp_v3_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Pdu Demo.SNMP V3 Password'] if 'Pdu Demo.SNMP V3 Password' in self.attributes else None
    ...
    def snmp_v3_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Pdu Demo.SNMP V3 Password'] = value
    ...
    def snmp_v3_private_key(self):
        ...
        :rtype: str
        """
        return self.attributes['Pdu Demo.SNMP V3 Private Key'] if 'Pdu Demo.SNMP V3 Private Key' in self.attributes else None
    ...
    def snmp_v3_private_key(self, value):
        ...
        :type value: str
        """
        self.attributes['Pdu Demo.SNMP V3 Private Key'] = value
    ...
    def snmp_version(self):
        ...
        :rtype: str
        """
        return self.attributes['Pdu Demo.SNMP Version'] if 'Pdu Demo.SNMP Version' in self.attributes else None
    ...
    def snmp_version(self, value=''):
        ...
        :type value: str
        """
        self.attributes['Pdu Demo.SNMP Version'] = value
    ...
    def enable_snmp(self):
        ...
        :rtype: bool
        """
        return self.attributes['Pdu Demo.Enable SNMP'] if 'Pdu Demo.Enable SNMP' in self.attributes else None
    ...
    def enable_snmp(self, value=True):
        ...
        :type value: bool
        """
        self.attributes['Pdu Demo.Enable SNMP'] = value
    ...
    def disable_snmp(self):
        ...
        :rtype: bool
        """
        return self.attributes['Pdu Demo.Disable SNMP'] if 'Pdu Demo.Disable SNMP' in self.attributes else None
    ...
    def disable_snmp(self, value=False):
        ...
        :type value: bool
        """
        self.attributes['Pdu Demo.Disable SNMP'] = value
    ...
    def console_server_ip_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Pdu Demo.Console Server IP Address'] if 'Pdu Demo.Console Server IP Address' in self.attributes else None
    ...
    def console_server_ip_address(self, value):
        ...
        :type value: str
        """
        self.attributes['Pdu Demo.Console Server IP Address'] = value
    ...
    def console_user(self):
        ...
        :rtype: str
        """
        return self.attributes['Pdu Demo.Console User'] if 'Pdu Demo.Console User' in self.attributes else None
    ...
    def console_user(self, value):
        ...
        :type value: str
        """
        self.attributes['Pdu Demo.Console User'] = value
    ...
    def console_port(self):
        ...
        :rtype: float
        """
        return self.attributes['Pdu Demo.Console Port'] if 'Pdu Demo.Console Port' in self.attributes else None
    ...
    def console_port(self, value):
        ...
        :type value: float
        """
        self.attributes['Pdu Demo.Console Port'] = value
    ...
    def console_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Pdu Demo.Console Password'] if 'Pdu Demo.Console Password' in self.attributes else None
    ...
    def console_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Pdu Demo.Console Password'] = value
    ...
    def cli_connection_type(self):
        ...
        :rtype: str
        """
        return self.attributes['Pdu Demo.CLI Connection Type'] if 'Pdu Demo.CLI Connection Type' in self.attributes else None
    ...
    def cli_connection_type(self, value='Auto'):
        ...
        :type value: str
        """
        self.attributes['Pdu Demo.CLI Connection Type'] = value
    ...
    def cli_tcp_port(self):
        ...
        :rtype: float
        """
        return self.attributes['Pdu Demo.CLI TCP Port'] if 'Pdu Demo.CLI TCP Port' in self.attributes else None
    ...
    def cli_tcp_port(self, value):
        ...
        :type value: float
        """
        self.attributes['Pdu Demo.CLI TCP Port'] = value
    ...
    def backup_location(self):
        ...
        :rtype: str
        """
        return self.attributes['Pdu Demo.Backup Location'] if 'Pdu Demo.Backup Location' in self.attributes else None
    ...
    def backup_location(self, value):
        ...
        :type value: str
        """
        self.attributes['Pdu Demo.Backup Location'] = value
    ...
    def backup_type(self):
        ...
        :rtype: str
        """
        return self.attributes['Pdu Demo.Backup Type'] if 'Pdu Demo.Backup Type' in self.attributes else None
    ...
    def backup_type(self, value='File System'):
        ...
        :type value: str
        """
        self.attributes['Pdu Demo.Backup Type'] = value
    ...
    def backup_user(self):
        ...
        :rtype: str
        """
        return self.attributes['Pdu Demo.Backup User'] if 'Pdu Demo.Backup User' in self.attributes else None
    ...
    def backup_user(self, value):
        ...
        :type value: str
        """
        self.attributes['Pdu Demo.Backup User'] = value
    ...
    def backup_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Pdu Demo.Backup Password'] if 'Pdu Demo.Backup Password' in self.attributes else None
    ...
    def backup_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Pdu Demo.Backup Password'] = value
...
class PowerSocket(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Pdu Demo.PowerSocket'
        self._name = name
