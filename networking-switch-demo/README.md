...
### **Networking Switch Demo**
**Networking Switch Demo** shell provides you with connectivity and management capabilities such as device structure discovery and power management for the resource. 

For more information on the device, see the vendor's official product documentation.

### Standard version
**Networking Switch Demo** is based on the Networking Shell Standard version **5.0.4**.
...
Release: **Networking Switch Demo**
...
#### **Networking Switch Demo Attributes**
...
The **Networking Switch Demo** shell is available from the [Quali Community Integrations](https://community.quali.com/integrations) page. 
...
|:---|:---|
|NetworkingSwitchDemo.zip|Device shell package|
|Networking_Switch_Demo_offline_dependencies.zip|Shell Python dependencies (for offline deployments only)|

# Importing and Configuring the Shell
This section describes how to import the **Networking Switch Demo** shell and configure and modify the shell’s devices.
...
1. Download the *Networking_Switch_Demo_offline_dependencies.zip* file, see [Downloading the Shell](#downloading-the-shell).
...
**To create a resource for the device:**
  ...
  2. From the list, select **Networking Switch Demo**.
...
For release updates, see the shell's [GitHub releases page](https://github.com/QualiSystems/NetworkingSwitchDemo/releases).
